...
export const Route = createFileRoute("/_public/blog/$slug")({
  ...
  head: ({ loaderData, params }) => ({
    meta: loaderData
      ? buildMeta({           title: `${loaderData.post.title} — STONDIA`,
          description: loaderData.post.excerpt,
          path: `/blog/${params.slug}`,
          ogImage: loaderData.post.image,
          ogType: "article",
        })
      : [           { title: "Post not found — STONDIA" },
    ...
    <>
      <article className="pt-28">
        <div className="container-lux max-w-3xl">
          ...
          <p className="mt-8 text-xs uppercase tracking-[0.15em] text-gold">
        ...
        <div className="container-lux mt-12 max-w-3xl space-y-6 text-lg leading-relaxed text-muted-foreground">
          <p>
            Rajasthan sandstone has shaped some of the most enduring architecture in the world. Its
            natural warmth, workability and remarkable durability make it a material of choice for
            architects and builders across every continent.
          </p>
          ...
          <p>
            ...
            Each decision affects not only aesthetics but long-term performance in the built
            environment, from weather resistance to maintenance requirements over decades of
            service.
          </p>
          ...
          <p>
            Our technical team works alongside architects and importers to ensure every
            specification is met to export-grade tolerances — supported by full documentation,
            samples and international packaging standards.
          </p>
        </div>
      </article>
