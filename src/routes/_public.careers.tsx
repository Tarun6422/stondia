...
const ROLES = [
  ...
  { title: "CNC Machine Operator", location: "Jodhpur, India", type: "Full-time", dept: "Manufacturing" },
  { title: "Quality Assurance Engineer", location: "Jodhpur, India", type: "Full-time", dept: "Quality" },
  { title: "Master Stone Carver", location: "Jodhpur, India", type: "Full-time", dept: "Craftsmanship" },
  { title: "Logistics Coordinator", location: "Jodhpur, India", type: "Full-time", dept: "Operations" },
                ...
                <div className="hover-lift group flex flex-col gap-4 rounded-lg border border-border bg-card p-6 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-4 text-sm text-muted-foreground">
                      <span className="inline-flex items-center gap-1.5"><Briefcase className="h-4 w-4 text-gold" /> {r.dept}</span>
                      <span className="inline-flex items-center gap-1.5"><MapPin className="h-4 w-4 text-gold" /> {r.location}</span>
                      <span>{r.type}</span>
                    </div>
                  </div>
