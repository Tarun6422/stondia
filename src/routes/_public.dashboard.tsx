...
import {
  Package, FileText, Download, User, ArrowUpRight, Mail, Phone,
  Building2, LogOut, Loader2, Settings,
} from "lucide-react";
...
function DashboardPage() {
  ...
  const roleLabel = user.role === "CUSTOMER" ? "Customer" : user.role === "ARCHITECT" ? "Architect" : user.role === "DEALER" ? "Dealer" : "Admin";
      ...
      <div className="container-lux">
        <Reveal>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-10">
            <div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="font-serif text-2xl text-foreground">Welcome, {user.name.split(" ")[0]}</h1>
            ...
            <div className="flex items-center gap-2">
              <Button asChild variant="outline" size="sm">
                <Link to="/profile"><Settings className="h-3.5 w-3.5" /> Profile</Link>
              </Button>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {/* Profile */}
            <Link to="/profile" className="group rounded-xl border border-border/60 bg-card p-6 transition-all hover:shadow-elegant hover:border-gold/20">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold/10 text-gold">
                <User className="h-5 w-5" />
              </div>
              <h3 className="mt-4 font-serif text-lg text-foreground">My Profile</h3>
              <p className="mt-1 text-sm text-muted-foreground">Edit your personal information, change password, and update avatar.</p>
            ...
            {/* My RFQs */}
            <Link to="/quote" className="group rounded-xl border border-border/60 bg-card p-6 transition-all hover:shadow-elegant hover:border-gold/20">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold/10 text-gold">
                <FileText className="h-5 w-5" />
              </div>
              <h3 className="mt-4 font-serif text-lg text-foreground">Request a Quote</h3>
              <p className="mt-1 text-sm text-muted-foreground">Submit a new quote request or upload project documents.</p>
              <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-gold group-hover:gap-1.5 transition-all">
            ...
            {/* Products */}
            <Link to="/products" className="group rounded-xl border border-border/60 bg-card p-6 transition-all hover:shadow-elegant hover:border-gold/20">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold/10 text-gold">
                <Package className="h-5 w-5" />
              </div>
              <h3 className="mt-4 font-serif text-lg text-foreground">Browse Products</h3>
              <p className="mt-1 text-sm text-muted-foreground">Explore our catalog of premium sandstone and natural stone.</p>
              <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-gold group-hover:gap-1.5 transition-all">
            ...
            {/* Downloads */}
            <Link to="/downloads" className="group rounded-xl border border-border/60 bg-card p-6 transition-all hover:shadow-elegant hover:border-gold/20">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold/10 text-gold">
                <Download className="h-5 w-5" />
              </div>
              <h3 className="mt-4 font-serif text-lg text-foreground">Resources</h3>
              <p className="mt-1 text-sm text-muted-foreground">Access brochures, technical specs, and installation guides.</p>
              <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-gold group-hover:gap-1.5 transition-all">
            ...
            {/* Contact */}
            <Link to="/contact" className="group rounded-xl border border-border/60 bg-card p-6 transition-all hover:shadow-elegant hover:border-gold/20">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold/10 text-gold">
                <Mail className="h-5 w-5" />
              </div>
              <h3 className="mt-4 font-serif text-lg text-foreground">Contact Support</h3>
              <p className="mt-1 text-sm text-muted-foreground">Get in touch with our export team for assistance.</p>
              <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-gold group-hover:gap-1.5 transition-all">
            ...
            {(isAdmin || user.role === "DEALER") && (
              <Link to="/admin" className="group rounded-xl border border-gold/20 bg-gradient-to-br from-gold/5 to-transparent p-6 transition-all hover:shadow-elegant">
                ...
                <p className="mt-1 text-sm text-muted-foreground">Manage products, projects, orders, and settings.</p>
                <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-gold group-hover:gap-1.5 transition-all">
            ...
            {isArchitect && (
              <Link to="/catalog" className="group rounded-xl border border-border/60 bg-card p-6 transition-all hover:shadow-elegant hover:border-gold/20">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gold/10 text-gold">
                  <Building2 className="h-5 w-5" />
                </div>
                <h3 className="mt-4 font-serif text-lg text-foreground">Project Catalog</h3>
                <p className="mt-1 text-sm text-muted-foreground">Browse completed projects and specification sheets.</p>
                <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-gold group-hover:gap-1.5 transition-all">
