...
export const PRODUCTS: Product[] = [
  {
    ...
    variants: [
      ...
      },
      {
        name: "Hand-Carved",
        label: "Hand-Carved",
        description: "Traditionally carved by master artisans.",
        image: carveDetail10,
      },
      {
        name: "Machine-Cut",
        label: "Machine-Cut",
        description: "CNC-precision cut for consistent patterns.",
        image: product08,
      },
    ],
    sizes: [
  ...
  },
  {
    ...
    shortDescription:
      "Our Sandstone Cobbles are precision-tumbled for naturally aged edges and warm, earthy tones. Perfect for driveways, walkways, and courtyards, each piece delivers the timeless character of authentic Rajasthan stone with the dimensional consistency required for modern landscape projects.",
    badges: ["Export Ready", "Best Seller"],
    gallery: [cobble01, cobble03, cobble05, cobble07, premium08, slab03, worksite04, premium05],
    variants: [
      {
        name: "Natural Split",
        label: "Natural Split",
        description: "Rough quarry surface with natural riven texture.",
        image: cobble01,
      },
      {
        name: "Tumbled",
        label: "Tumbled",
        description: "Aged, rounded edges with a rustic appearance.",
        image: cobble05,
      },
      {
        name: "Sawn",
        label: "Sawn",
        description: "Clean machine-cut edges for precise laying.",
        image: block08,
      },
      {
        name: "Sandblasted",
        label: "Sandblasted",
        description: "Uniform matte texture with slip resistance.",
        image: process08,
      },
    ],
    sizes: [
  ...
  },
  {
    ...
    stockStatus: "Available",
    shortDescription:
      "Each Carved Stone Column is hand-sculpted by master artisans in Jodhpur, using techniques refined over centuries. Available in traditional and contemporary profiles, these columns provide structural grandeur for luxury villas, hotels, and temple architecture.",
    ...
    variants: [
      {
        name: "Hand-Carved",
        label: "Hand-Carved",
        description: "Traditionally sculpted by master artisans.",
        image: product04,
      },
      {
        name: "Polished",
        label: "Polished",
        description: "High-gloss finish revealing natural grain.",
        image: premium03,
      },
      {
        name: "Honed",
        label: "Honed",
        description: "Smooth matte finish with a soft appearance.",
        image: finish03,
      },
    ],
    sizes: [
  ...
  },
  {
    ...
    stockStatus: "Ready to Ship",
    shortDescription:
      "Precision-calibrated sandstone cladding panels engineered for luxury facades worldwide. Each panel is cut to exact export tolerances with consistent colour and texture — specified by leading architects for premium residential and commercial projects across 35+ countries.",
    badges: ["Export Ready", "Best Seller", "Sustainability"],
    gallery: [texture02, texture03, arch01, arch03, arch05, project01, project05, finish06],
    variants: [
      {
        name: "Natural",
        label: "Natural",
        description: "Original quarry surface with natural character.",
        image: texture02,
      },
      {
        name: "Honed",
        label: "Honed",
        description: "Smooth matte finish with a soft touch.",
        image: finish06,
      },
      {
        name: "Brushed",
        label: "Brushed",
        description: "Subtle textured finish for exterior use.",
        image: premium05,
      },
      {
        name: "Sandblasted",
        label: "Sandblasted",
        description: "Uniform matte with enhanced slip resistance.",
        image: product01,
      },
    ],
    sizes: [
  ...
  },
  {
    ...
    stockStatus: "Ready to Ship",
    shortDescription:
      "Desert Gold Flooring combines the warm, honeyed tones of Rajasthan sandstone with precision calibration for flawless interior and exterior installations. These tiles bring natural elegance to lobbies, terraces, pool surrounds, and luxury residences.",
    badges: ["Export Ready", "Best Seller", "Sustainability"],
    gallery: [paving01, paving03, paving05, paving08, finish01, finish03, product06, slab05],
    variants: [
      {
        name: "Honed",
        label: "Honed",
        description: "Smooth matte finish with velvety texture.",
        image: paving08,
      },
      {
        name: "Polished",
        label: "Polished",
        description: "High-gloss mirror finish for interiors.",
        image: slab05,
      },
      {
        name: "Leather",
        label: "Leather",
        description: "Satin matte with subtle surface texture.",
        image: premium08,
      },
      {
        name: "Flamed",
        label: "Flamed",
        description: "Thermally treated for slip-resistant exterior use.",
        image: finish03,
      },
    ],
    sizes: [
  ...
  },
  {
    ...
    shortDescription:
      "Our Heritage Carvings are bespoke ornamental masterpieces hand-carved by master artisans for temple construction, palace restoration, and luxury residences. Each piece is a unique work of art — from intricate deities to geometric patterns and floral motifs.",
    badges: ["Export Ready"],
    gallery: [
      carving03,
      carving06,
    ...
    variants: [
      ...
      },
      {
        name: "Antique",
        label: "Antique",
        description: "Aged, weathered finish for heritage projects.",
        image: carveDetail22,
      },
    ],
    sizes: [{ label: "Custom Size", thickness: ["Per specification"] }],
    technicalSpecs: [
